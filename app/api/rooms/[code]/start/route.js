...
export async function POST(req, { params }) {
  ...
  const categoryKey = body.categoryKey || 'random';
  const language = ['pt','en','de'].includes(body.language) ? body.language : 'pt';
